...
\noindent
 $ii)$ When $p_m\ll m^{-1}$, for all $q=d+1,\ldots, 1+(d-1)n$ we have
\begin{align}
  \label{fjkldfaa1-2}
 ...
 satisfies 
  \begin{eqnarray*}
    \kappa_n\left(\widebar{\sigma}_k (t)\right)\leq \begin{cases}
      \displaystyle
      \frac{C n!^{d+1}}{(m p_m)^{n/2-1}}~~~~~~~{when}~~~p_m \gg m^{-(d-1)/d},
      \medskip
      \\
      \displaystyle
      \frac{C n!^{d+1}}{\big(m^d p_m^{d+1}\big)^{n/2-1}}~~~~{when}~~~p_m\ll m^{-1},
    \end{cases}
\end{eqnarray*}
...
% \begin{equation} j^{j-1}<\frac{(j-1)!}{\sqrt{2\pi j}}e^j. \end{equation}
  $i)$ When $p_m \gg m^{-(d-1)/d}$, from the inequalities  
 ...
 satisfies  
  \begin{eqnarray*}
    \kappa_3\left(\widebar{\sigma}_k (t)\right)\leq \begin{cases}
      \displaystyle
      \frac{C}{(m p_m)^{1/2}}~~~~~~~{when}~~~\textcolor{red}{p_m} \gg m^{-1+1/d},
      \medskip
      \\
      \displaystyle
      \frac{C}{(m^d p_m^{d+1})^{1/2}}~~~~{when}~~~p_m\ll m^{-1},
    \end{cases}
\end{eqnarray*}
